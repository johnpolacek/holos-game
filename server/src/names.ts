...
export const NAME_TAILS = [
  ...
  "setters", "layers", "raisers", "planers", "minders", "healers", "nurses", "fosterers",
  "shepherds", "herders", "drovers", "breeders", "tamers", "feeders", "gentlers", "soothers",
  "calmers", "stillers", "warders", "guardians", "shielders", "defenders", "sentinels", "watchers",
  "wakers", "rousers", "stirrers", "seekers", "finders", "searchers", "questers", "wanderers",
  "roamers", "rovers", "wayfarers", "walkers", "striders", "treaders", "pacers", "runners",
  "chasers", "hunters", "trackers", "stalkers", "followers", "leaders", "guiders", "steerers",
  "sailors", "mariners", "rowers", "ferriers", "divers", "miners", "diggers", "climbers",
  "scalers", "leapers", "vaulters", "gliders", "drifters", "riders", "haulers", "carriers",
  "porters", "bearers", "drawers", "slingers", "throwers", "reapers", "gleaners", "gatherers",
  "harvesters", "threshers", "winnowers", "tillers", "plowers", "planters", "pruners", "grafters",
  "foragers", "storers", "hoarders", "garnerers", "rooters", "cullers", "pickers", "criers",
  "heralds", "speakers", "tellers", "sayers", "chanters", "reciters", "readers", "writers",
  "scribes", "namers", "markers", "sealers", "witnesses", "counters", "tallyers", "measurers",
  "weighers", "gaugers", "mappers", "plotters", "charters", "seers", "dreamers", "augurs",
  "diviners", "observers", "scanners", "recorders", "chroniclers", "rememberers", "mourners", "keeners",
  "wailers", "questioners", "answerers", "learners", "teachers", "provers", "solvers", "breakers",
  "shatterers", "sunderers", "cleavers", "splitters", "renders", "fellers", "crushers", "splinterers",
  "biters", "gnawers", "quellers", "dousers", "enders", "holders", "wielders", "upholders",
  "withholders", "lighters", "brighteners", "warmers", "coolers", "thawers", "freezers", "bringers",
  "givers", "takers", "granters", "lenders", "traders", "dealers", "changers", "sorters",
  "sifters", "choosers", "cleaners", "scourers", "polishers", "burnishers", "veilers", "maskers",
  "coverers", "wrappers", "folders", "openers", "closers",
] as const;
