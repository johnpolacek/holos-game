...
**Status (2026-07):** A2.1, A2.2, A2.2b and A2.3 are shipped — their
blocks stay below as record (systems-a.md §2.7 and §2.8 are A2.3's
as-built record). **A2.4 is the open stage.** A2.2b also shipped the
