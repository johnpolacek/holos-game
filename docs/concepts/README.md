...
| Act 3 — home system (present tense) | *(generate next)* | **Wanted now — A1's missing frame** | Screen 17 — the zoomed-in start of the continuous camera, the first frame after inheriting and the game's only present-tense view: crisp/certain at home, soft/old at the edges. Suggested file: `03-02-home-system.png`. |
